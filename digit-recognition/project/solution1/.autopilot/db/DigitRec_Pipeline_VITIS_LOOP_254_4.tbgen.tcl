set moduleName DigitRec_Pipeline_VITIS_LOOP_254_4
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {DigitRec_Pipeline_VITIS_LOOP_254_4}
set C_modelType { void 0 }
set C_modelArgList {
	{ global_results int 8 regular {array 2000 { 0 3 } 0 1 }  }
	{ results int 4 regular {array 2000 { 1 3 } 1 1 } {global 0}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "global_results", "interface" : "memory", "bitwidth" : 8, "direction" : "WRITEONLY"} , 
 	{ "Name" : "results", "interface" : "memory", "bitwidth" : 4, "direction" : "READONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ global_results_address0 sc_out sc_lv 11 signal 0 } 
	{ global_results_ce0 sc_out sc_logic 1 signal 0 } 
	{ global_results_we0 sc_out sc_logic 1 signal 0 } 
	{ global_results_d0 sc_out sc_lv 8 signal 0 } 
	{ results_address0 sc_out sc_lv 11 signal 1 } 
	{ results_ce0 sc_out sc_logic 1 signal 1 } 
	{ results_q0 sc_in sc_lv 4 signal 1 } 
}
set NewPortList {[ 
...
set Spec2ImplPortList { 
	...
	results { ap_memory {  { results_address0 mem_address 1 11 }  { results_ce0 mem_ce 1 1 }  { results_q0 in_data 0 4 } } }
}
