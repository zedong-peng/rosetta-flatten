...
module DigitRec_DigitRec_Pipeline_FIND_MAX_DIST (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
output  [31:0] max_dist_out;
output   max_dist_out_ap_vld;
output  [6:0] max_dist_id_out;
output   max_dist_id_out_ap_vld;

reg ap_idle;
reg max_dist_out_ap_vld;
reg max_dist_id_out_ap_vld;
...
wire   [0:0] icmp_ln76_fu_1060_p2;
reg    ap_condition_exit_pp0_iter1_stage0;
wire    ap_loop_exit_ready;
reg    ap_ready_int;
wire    ap_block_pp0_stage0_11001;
reg   [31:0] max_dist_id_fu_282;
wire   [31:0] max_dist_id_3_fu_1220_p3;
wire    ap_loop_init;
wire    ap_block_pp0_stage0;
reg   [31:0] max_dist_fu_286;
wire   [31:0] max_dist_1_fu_1228_p3;
reg   [1:0] k_fu_290;
wire   [1:0] add_ln76_fu_1066_p2;
wire    ap_block_pp0_stage0_01001;
wire   [6:0] zext_ln78_fu_1075_p1;
wire   [6:0] tmp_s_fu_1084_p121;
wire   [31:0] tmp_s_fu_1084_p122;
wire   [0:0] icmp_ln78_fu_1210_p2;
wire   [31:0] zext_ln78_1_fu_1216_p1;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            k_fu_290 <= 2'd0;
        end else if (((icmp_ln76_fu_1060_p2 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
...
always @ (*) begin
    if (((icmp_ln76_fu_1060_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((icmp_ln76_fu_1060_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        max_dist_id_out_ap_vld = 1'b1;
    end else begin
        max_dist_id_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln76_fu_1060_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        max_dist_out_ap_vld = 1'b1;
    end else begin
        max_dist_out_ap_vld = 1'b0;
    end
end
...
assign add_ln76_fu_1066_p2 = (k_fu_290 + 2'd1);
...
assign icmp_ln76_fu_1060_p2 = ((k_fu_290 == 2'd3) ? 1'b1 : 1'b0);

assign icmp_ln78_fu_1210_p2 = (($signed(max_dist_fu_286) < $signed(tmp_s_fu_1084_p122)) ? 1'b1 : 1'b0);

assign max_dist_1_fu_1228_p3 = ((icmp_ln78_fu_1210_p2[0:0] == 1'b1) ? tmp_s_fu_1084_p122 : max_dist_fu_286);

assign max_dist_id_3_fu_1220_p3 = ((icmp_ln78_fu_1210_p2[0:0] == 1'b1) ? zext_ln78_1_fu_1216_p1 : max_dist_id_fu_282);

assign max_dist_id_out = max_dist_id_fu_282[6:0];

assign max_dist_out = max_dist_fu_286;

assign tmp_s_fu_1084_p121 = (zext_ln78_fu_1075_p1 + sub_ln78);

assign zext_ln78_1_fu_1216_p1 = k_fu_290;

assign zext_ln78_fu_1075_p1 = k_fu_290;

endmodule //DigitRec_DigitRec_Pipeline_FIND_MAX_DIST
