...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename z_buffer_V \
    op interface \
    ports { z_buffer_V_address0 { O 16 vector } z_buffer_V_ce0 { O 1 bit } z_buffer_V_we0 { O 1 bit } z_buffer_V_d0 { O 8 vector } z_buffer_V_q0 { I 8 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    id 97 \
    name agg_result_0_out \
    type other \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_agg_result_0_out \
    op interface \
    ports { agg_result_0_out { O 16 vector } agg_result_0_out_ap_vld { O 1 bit } } \
} "
}
