...
__attribute__((sdx_kernel("rendering", 0))) void rendering( bit32 input[3*NUM_3D_TRI], bit32 output[NUM_FB])
{
#line 8 "/data/zedongpeng/HLSBatchProcessor/data/kernels/rosetta_flatten/3d-rendering/run_hls.tcl"
