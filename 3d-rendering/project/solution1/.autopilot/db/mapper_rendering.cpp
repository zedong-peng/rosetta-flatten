...
using hls::sim::Byte;
extern "C" void rendering(Byte<4>*, Byte<4>*);
extern "C" void apatb_rendering_hw(volatile void * __xlx_apatb_param_input_r, volatile void * __xlx_apatb_param_output_r) {
using hls::sim::createStream;
  // Collect __xlx_input_r__tmp_vec
std::vector<Byte<4>> __xlx_input_r__tmp_vec;
for (size_t i = 0; i < 9576; ++i){
__xlx_input_r__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_input_r)[i]);
}
  int __xlx_size_param_input_r = 9576;
...
__xlx_output_r__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_output_r)[i]);
  ...
  // DUT call
  rendering(__xlx_input_r__tmp_vec.data(), __xlx_output_r__tmp_vec.data());
