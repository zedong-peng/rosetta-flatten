...
// wrapc file define:
#define AUTOTB_TVIN_frames "../tv/cdatafile/c.optical_flow.autotvin_frames.dat"
#define AUTOTB_TVOUT_frames "../tv/cdatafile/c.optical_flow.autotvout_frames.dat"
#define AUTOTB_TVIN_outputs "../tv/cdatafile/c.optical_flow.autotvin_outputs.dat"
#define AUTOTB_TVOUT_outputs "../tv/cdatafile/c.optical_flow.autotvout_outputs.dat"


// tvout file define:
#define AUTOTB_TVOUT_PC_outputs "../tv/rtldatafile/rtl.optical_flow.autotvout_outputs.dat"
...
extern "C"
void optical_flow_hw_stub_wrapper(void*, void*);

extern "C"
void apatb_optical_flow_hw(void* __xlx_apatb_param_frames, void* __xlx_apatb_param_outputs)
{
#ifdef USE_BINARY_TV_FILE
  ...
  static hls::sim::Memory<hls::sim::Reader, hls::sim::Writer> port0 {
    ...
    .owriter = nullptr,
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_frames),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_frames),
#endif
#endif
  };
  port0.param = { __xlx_apatb_param_frames };
  port0.depth = { 446464 };
  port0.offset = {  };
...
#ifdef POST_CHECK
#ifdef USE_BINARY_TV_FILE
    .reader = new hls::sim::Input(AUTOTB_TVOUT_PC_outputs),
#else
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_outputs),
#endif
#else
#ifdef USE_BINARY_TV_FILE
    .owriter = new hls::sim::Output(AUTOTB_TVOUT_outputs),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_outputs),
#endif
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_outputs),
#else
  ...
  try {
    ...
    optical_flow_hw_stub_wrapper(__xlx_apatb_param_frames, __xlx_apatb_param_outputs);
