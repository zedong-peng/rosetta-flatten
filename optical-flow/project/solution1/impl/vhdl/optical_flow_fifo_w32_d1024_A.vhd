...
entity optical_flow_fifo_w32_d1024_A is
    generic (
...
architecture arch of optical_flow_fifo_w32_d1024_A is

    -- component
    component optical_flow_fifo_w32_d1024_A_ram is
    generic (
        MEM_STYLE  : string  := "auto";
...
begin
----------------------- Instantiation -----------------------
    U_optical_flow_fifo_w32_d1024_A_ram : optical_flow_fifo_w32_d1024_A_ram
    generic map (
        MEM_STYLE  => MEM_STYLE,
...
entity optical_flow_fifo_w32_d1024_A_ram is
    generic (
        MEM_STYLE   : string  := "auto";
        DATA_WIDTH  : integer := 32;
        ADDR_WIDTH  : integer := 10;
...
architecture arch of optical_flow_fifo_w32_d1024_A_ram is
