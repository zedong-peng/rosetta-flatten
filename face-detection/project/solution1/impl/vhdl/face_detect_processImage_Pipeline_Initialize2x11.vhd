...
entity face_detect_processImage_Pipeline_Initialize2x11 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of face_detect_processImage_Pipeline_Initialize2x11 is 
...
attribute shreg_extract : string;
    ...
    signal x_6_cast_fu_68_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal x_6_fu_30 : STD_LOGIC_VECTOR (8 downto 0);
...
begin
    ...
    x_6_fu_30_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_start_int = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
                if ((icmp_ln2956_fu_56_p2 = ap_const_lv1_0)) then 
                    x_6_fu_30 <= add_ln2956_fu_62_p2;
                elsif ((ap_loop_init = ap_const_logic_1)) then 
                    x_6_fu_30 <= ap_const_lv9_0;
                end if;
            end if; 
        end if;
    end process;
    ...
    L_6_address0 <= x_6_cast_fu_68_p1(9 - 1 downto 0);

    L_6_ce0_assign_proc : process(ap_CS_fsm_state1, ap_start_int)
    begin
        if (((ap_start_int = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    L_6_we0_assign_proc : process(ap_CS_fsm_state1, icmp_ln2956_fu_56_p2, ap_start_int)
    begin
    ...
    ap_sig_allocacmp_x_assign_proc : process(ap_CS_fsm_state1, x_6_fu_30, ap_loop_init)
    begin
        if (((ap_loop_init = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            ap_sig_allocacmp_x <= ap_const_lv9_0;
        else 
            ap_sig_allocacmp_x <= x_6_fu_30;
        end if; 
    end process;

    icmp_ln2956_fu_56_p2 <= "1" when (ap_sig_allocacmp_x = ap_const_lv9_140) else "0";
    x_6_cast_fu_68_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_x),64));
end behav;
