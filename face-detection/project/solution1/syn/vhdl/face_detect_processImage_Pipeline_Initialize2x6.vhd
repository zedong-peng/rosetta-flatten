...
entity face_detect_processImage_Pipeline_Initialize2x6 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of face_detect_processImage_Pipeline_Initialize2x6 is 
...
attribute shreg_extract : string;
    ...
    signal x_1_cast_fu_68_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal x_1_fu_30 : STD_LOGIC_VECTOR (8 downto 0);
...
begin
    ...
    L_1_address0 <= x_1_cast_fu_68_p1(9 - 1 downto 0);

    L_1_ce0_assign_proc : process(ap_CS_fsm_state1, ap_start_int)
    begin
        if (((ap_start_int = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    L_1_we0_assign_proc : process(ap_CS_fsm_state1, icmp_ln2956_fu_56_p2, ap_start_int)
    begin
    ...
    x_1_cast_fu_68_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_x),64));
end behav;
