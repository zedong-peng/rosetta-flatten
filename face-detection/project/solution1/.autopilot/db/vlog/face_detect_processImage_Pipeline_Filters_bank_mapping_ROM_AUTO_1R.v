...
// ==============================================================
`timescale 1 ns / 1 ps
module face_detect_processImage_Pipeline_Filters_bank_mapping_ROM_AUTO_1R (
    address0, ce0, q0, 
    address1, ce1, q1, 
    address2, ce2, q2, 
    address3, ce3, q3, 
...
initial begin
    ...
    $readmemh("./face_detect_processImage_Pipeline_Filters_bank_mapping_ROM_AUTO_1R.dat", rom0); 
    $readmemh("./face_detect_processImage_Pipeline_Filters_bank_mapping_ROM_AUTO_1R.dat", rom1); 
    $readmemh("./face_detect_processImage_Pipeline_Filters_bank_mapping_ROM_AUTO_1R.dat", rom2); 
    $readmemh("./face_detect_processImage_Pipeline_Filters_bank_mapping_ROM_AUTO_1R.dat", rom3); 
    $readmemh("./face_detect_processImage_Pipeline_Filters_bank_mapping_ROM_AUTO_1R.dat", rom4); 
    $readmemh("./face_detect_processImage_Pipeline_Filters_bank_mapping_ROM_AUTO_1R.dat", rom5);
end
