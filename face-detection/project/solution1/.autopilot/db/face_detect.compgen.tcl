...
set name face_detect_fdiv_32ns_32ns_32_6_no_dsp_1
if {${::AESL::PGuard_rtl_comp_handler}} {
...
set name face_detect_sdiv_27ns_32ns_26_31_seq_1
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {sdiv} IMPL {auto_seq} LATENCY 30 ALLOW_PRAGMA 1
}


set name face_detect_sdiv_26ns_32ns_24_30_seq_1
if {${::AESL::PGuard_rtl_comp_handler}} {
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler face_detect_Data_RAM_AUTO_1R1W BINDTYPE {storage} TYPE {ram} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler face_detect_result_x_Scale_RAM_AUTO_1R1W BINDTYPE {storage} TYPE {ram} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}
