set moduleName dataflow_in_loop_TRAINING_INST
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {dataflow_in_loop_TRAINING_INST}
...
set portList { 
	...
	{ data_d0 sc_out sc_lv 512 signal 1 } 
	{ data_q0 sc_in sc_lv 512 signal 1 } 
	{ data_we0 sc_out sc_logic 1 signal 1 } 
	{ data_address1 sc_out sc_lv 18 signal 1 } 
	{ data_ce1 sc_out sc_logic 1 signal 1 } 
	{ data_d1 sc_out sc_lv 512 signal 1 } 
	{ data_q1 sc_in sc_lv 512 signal 1 } 
	...
	{ theta_local_V_d1 sc_out sc_lv 32 signal 2 } 
	{ theta_local_V_q1 sc_in sc_lv 32 signal 2 } 
	{ theta_local_V_we1 sc_out sc_logic 1 signal 2 } 
	{ label_local_V_address0 sc_out sc_lv 13 signal 3 } 
	{ label_local_V_ce0 sc_out sc_logic 1 signal 3 } 
	{ label_local_V_d0 sc_out sc_lv 8 signal 3 } 
	{ label_local_V_q0 sc_in sc_lv 8 signal 3 } 
	{ label_local_V_we0 sc_out sc_logic 1 signal 3 } 
	{ label_local_V_address1 sc_out sc_lv 13 signal 3 } 
	{ label_local_V_ce1 sc_out sc_logic 1 signal 3 } 
	{ label_local_V_d1 sc_out sc_lv 8 signal 3 } 
	{ label_local_V_q1 sc_in sc_lv 8 signal 3 } 
	{ label_local_V_we1 sc_out sc_logic 1 signal 3 } 
	{ ap_clk sc_in sc_logic 1 clock -1 } 
	{ ap_rst sc_in sc_logic 1 reset -1 active_high_sync } 
	{ trunc_ln280_ap_vld sc_in sc_logic 1 invld 0 } 
...
set NewPortList {[ 
	{ "name": "trunc_ln280", "direction": "in", "datatype": "sc_lv", "bitwidth":13, "type": "signal", "bundle":{"name": "trunc_ln280", "role": "default" }} , 
 	...
 	{ "name": "trunc_ln280_ap_vld", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "invld", "bundle":{"name": "trunc_ln280", "role": "ap_vld" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "14"],
		...
		"IsBlackBox" : "0",
		"InputProcess" : [
			{"ID" : "1", "Name" : "READ_TRAINING_DATA_proc_U0"},
		...
		"Port" : [
			...
			{"Name" : "data", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "READ_TRAINING_DATA_proc_U0", "Port" : "data"}]},
			{"Name" : "training_instance_V", "Type" : "Memory", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "compute_U0", "Port" : "training_instance_V"},
					{"ID" : "1", "SubInstance" : "READ_TRAINING_DATA_proc_U0", "Port" : "training_instance_V"}]},
			{"Name" : "theta_local_V", "Type" : "Memory", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "compute_U0", "Port" : "theta_local_V"}]},
			{"Name" : "lut_V", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "compute_U0", "Port" : "lut_V"}]},
			{"Name" : "label_local_V", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "compute_U0", "Port" : "label_local_V"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.READ_TRAINING_DATA_proc_U0", "Parent" : "0",
		...
		"Port" : [
			{"Name" : "trunc_ln280", "Type" : "None", "Direction" : "I"},
			{"Name" : "data", "Type" : "Memory", "Direction" : "I"},
			{"Name" : "training_instance_V", "Type" : "Memory", "Direction" : "O", "DependentProc" : ["2"], "DependentChan" : "14"}],
		"Loop" : [
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.compute_U0", "Parent" : "0", "Child" : ["3", "4", "5", "8", "11"],
		"CDFG" : "compute",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "1", "ap_idle" : "1", "real_start" : "0",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		...
		"Port" : [
			...
			{"Name" : "theta_local_V", "Type" : "Memory", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "5", "SubInstance" : "grp_compute_Pipeline_DOT_DOT_INNER_fu_98", "Port" : "theta_local_V", "Inst_start_state" : "1", "Inst_end_state" : "2"},
					{"ID" : "11", "SubInstance" : "grp_compute_Pipeline_UPDATE_UPDATE_INNER_fu_115", "Port" : "theta_local_V", "Inst_start_state" : "6", "Inst_end_state" : "7"}]},
			{"Name" : "training_instance_V", "Type" : "Memory", "Direction" : "I", "DependentProc" : ["1"], "DependentChan" : "14",
				"SubConnect" : [
					{"ID" : "5", "SubInstance" : "grp_compute_Pipeline_DOT_DOT_INNER_fu_98", "Port" : "training_instance_V", "Inst_start_state" : "1", "Inst_end_state" : "2"},
					{"ID" : "8", "SubInstance" : "grp_compute_Pipeline_GRAD_GRAD_INNER_fu_107", "Port" : "training_instance_V", "Inst_start_state" : "4", "Inst_end_state" : "5"}]},
			{"Name" : "lut_V", "Type" : "Memory", "Direction" : "I"}]},
	{"ID" : "3", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.compute_U0.lut_V_U", "Parent" : "2"},
	{"ID" : "4", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.compute_U0.gradient_V_U", "Parent" : "2"},
	{"ID" : "5", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.compute_U0.grp_compute_Pipeline_DOT_DOT_INNER_fu_98", "Parent" : "2", "Child" : ["6", "7"],
	...
	{"ID" : "6", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.compute_U0.grp_compute_Pipeline_DOT_DOT_INNER_fu_98.mul_32s_16s_44_1_1_U6", "Parent" : "5"},
	{"ID" : "7", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.compute_U0.grp_compute_Pipeline_DOT_DOT_INNER_fu_98.flow_control_loop_pipe_sequential_init_U", "Parent" : "5"},
	{"ID" : "8", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.compute_U0.grp_compute_Pipeline_GRAD_GRAD_INNER_fu_107", "Parent" : "2", "Child" : ["9", "10"],
	...
	{"ID" : "9", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.compute_U0.grp_compute_Pipeline_GRAD_GRAD_INNER_fu_107.mul_mul_28s_16s_44_4_1_U11", "Parent" : "8"},
	{"ID" : "10", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.compute_U0.grp_compute_Pipeline_GRAD_GRAD_INNER_fu_107.flow_control_loop_pipe_sequential_init_U", "Parent" : "8"},
	{"ID" : "11", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.compute_U0.grp_compute_Pipeline_UPDATE_UPDATE_INNER_fu_115", "Parent" : "2", "Child" : ["12", "13"],
		...
		"Loop" : [
			{"Name" : "UPDATE_UPDATE_INNER", "PipelineType" : "UPC",
				"LoopDec" : {"FSMBitwidth" : "1", "FirstState" : "ap_ST_fsm_pp0_stage0", "FirstStateIter" : "ap_enable_reg_pp0_iter0", "FirstStateBlock" : "ap_block_pp0_stage0_subdone", "LastState" : "ap_ST_fsm_pp0_stage0", "LastStateIter" : "ap_enable_reg_pp0_iter1", "LastStateBlock" : "ap_block_pp0_stage0_subdone", "QuitState" : "ap_ST_fsm_pp0_stage0", "QuitStateIter" : "ap_enable_reg_pp0_iter0", "QuitStateBlock" : "ap_block_pp0_stage0_subdone", "OneDepthLoop" : "0", "has_ap_ctrl" : "1", "has_continue" : "0"}}]},
	{"ID" : "12", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.compute_U0.grp_compute_Pipeline_UPDATE_UPDATE_INNER_fu_115.mul_32s_32s_51_1_1_U16", "Parent" : "11"},
	{"ID" : "13", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.compute_U0.grp_compute_Pipeline_UPDATE_UPDATE_INNER_fu_115.flow_control_loop_pipe_sequential_init_U", "Parent" : "11"},
	{"ID" : "14", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.training_instance_V_U", "Parent" : "0"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "4209", "Max" : "4209"}
	, {"Name" : "Interval", "Min" : "3088", "Max" : "3088"}
]}
...
set Spec2ImplPortList { 
	trunc_ln280 { ap_none {  { trunc_ln280 in_data 0 13 }  { trunc_ln280_ap_vld in_vld 0 1 } } }
