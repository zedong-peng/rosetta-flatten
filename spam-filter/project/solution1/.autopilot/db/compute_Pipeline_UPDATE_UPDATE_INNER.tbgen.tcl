set moduleName compute_Pipeline_UPDATE_UPDATE_INNER
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {compute_Pipeline_UPDATE_UPDATE_INNER}
set C_modelType { void 0 }
set C_modelArgList {
	{ gradient_V int 32 regular {array 1024 { 1 3 } 1 1 }  }
	{ theta_local_V int 32 regular {array 1024 { 0 1 } 1 1 } {global 2}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "gradient_V", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ gradient_V_address0 sc_out sc_lv 10 signal 0 } 
	{ gradient_V_ce0 sc_out sc_logic 1 signal 0 } 
	{ gradient_V_q0 sc_in sc_lv 32 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "gradient_V_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "gradient_V", "role": "q0" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_32s_32s_51_1_1_U16", "Parent" : "0"},
...
set Spec2ImplPortList { 
	gradient_V { ap_memory {  { gradient_V_address0 mem_address 1 10 }  { gradient_V_ce0 mem_ce 1 1 }  { gradient_V_q0 in_data 0 32 } } }
	theta_local_V { ap_memory {  { theta_local_V_address0 mem_address 1 10 }  { theta_local_V_ce0 mem_ce 1 1 }  { theta_local_V_we0 mem_we 1 1 }  { theta_local_V_d0 mem_din 1 32 }  { theta_local_V_address1 MemPortADDR2 1 10 }  { theta_local_V_ce1 MemPortCE2 1 1 }  { theta_local_V_q1 in_data 0 32 } } }
}
