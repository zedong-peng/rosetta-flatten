set moduleName SgdLR_Pipeline_STREAM_OUT
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {SgdLR_Pipeline_STREAM_OUT}
set C_modelType { void 0 }
set C_modelArgList {
	{ theta int 512 regular {array 64 { 0 3 } 0 1 }  }
	{ theta_local_V int 32 regular {array 1024 { 1 1 } 1 1 } {global 0}  }
}
...
set portList { 
	...
	{ theta_address0 sc_out sc_lv 6 signal 0 } 
	{ theta_ce0 sc_out sc_logic 1 signal 0 } 
	{ theta_we0 sc_out sc_logic 1 signal 0 } 
	{ theta_d0 sc_out sc_lv 512 signal 0 } 
...
set Spec2ImplPortList { 
	...
	theta_local_V { ap_memory {  { theta_local_V_address0 mem_address 1 10 }  { theta_local_V_ce0 mem_ce 1 1 }  { theta_local_V_q0 in_data 0 32 }  { theta_local_V_address1 MemPortADDR2 1 10 }  { theta_local_V_ce1 MemPortCE2 1 1 }  { theta_local_V_q1 in_data 0 32 } } }
}
